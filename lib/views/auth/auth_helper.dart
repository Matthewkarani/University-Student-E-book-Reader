...
//to check if user already exists
    ...
    if((await userRef.get()).exists){
      await userRef.update({
        ...
        "build_number":buildNumber, //usermight have updated appbuild number helps when sending push notifiications to get device type..smth like that
      });
    }else {
...
//saving device details
  ...
  final deviceRef = _db.collection('users').doc(user.uid).collection('devices')
      .doc(deviceId);
